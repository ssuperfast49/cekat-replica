    ...
    <button
      ...
      className={cn(
        ...
        active
          ...
          : "text-muted-foreground hover:bg-blue-50 hover:text-blue-600 hover:border hover:border-blue-100 dark:hover:bg-blue-900/20 dark:hover:text-blue-400 dark:hover:border-blue-900",
        collapsed && "grid-cols-[1.125rem,0fr]"
      )}
      aria-current={active ? "page" : undefined}
      title={collapsed ? label : undefined}
    >
      <Icon className={`h-4 w-4 shrink-0 transition-colors ${active ? "text-blue-600 dark:text-blue-400" : "group-hover:text-blue-600 dark:group-hover:text-blue-400"}`} />
      <span
        className={cn(
