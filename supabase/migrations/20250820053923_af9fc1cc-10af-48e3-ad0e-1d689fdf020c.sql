...
DO $$
DECLARE
  has_model_column boolean;
  has_temperature_column boolean;
BEGIN
  SELECT EXISTS (
    SELECT 1
  ...
  INTO has_temperature_column;

  IF has_model_column AND has_temperature_column THEN
