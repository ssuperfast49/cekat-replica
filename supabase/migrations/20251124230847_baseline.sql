...
ALTER TYPE "public"."label_scope" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."add_default_collaborators"() RETURNS "trigger"
...
ALTER FUNCTION "public"."add_default_collaborators"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."after_token_log_refresh_daily_monthly"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."after_token_log_refresh_daily_monthly"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."after_token_log_refresh_used_tokens"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
begin
...
ALTER FUNCTION "public"."after_token_log_refresh_used_tokens"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."auto_close_due_threads"() RETURNS integer
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."auto_close_due_threads"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."auto_resolve_threads"() RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."auto_resolve_threads"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."can_read_thread"("p_thread_id" "uuid") RETURNS boolean
    LANGUAGE "sql"
    AS $$
  with me as (
...
ALTER FUNCTION "public"."can_read_thread"("p_thread_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."cancel_auto_resolve_on_user_message"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."cancel_auto_resolve_on_user_message"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."check_and_auto_resolve_threads"() RETURNS TABLE("resolved_thread_id" "uuid", "thread_contact_name" "text", "auto_resolve_reason" "text")
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."check_and_auto_resolve_threads"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."cleanup_old_chat_data"("p_org_id" "uuid" DEFAULT NULL::"uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."cleanup_old_chat_data"("p_org_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."create_email_2fa_challenge"("p_user" "uuid", "p_ttl_seconds" integer DEFAULT 600) RETURNS TABLE("challenge_id" "uuid", "code_plain" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
...
ALTER FUNCTION "public"."create_email_2fa_challenge"("p_user" "uuid", "p_ttl_seconds" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."enforce_handover_reason"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."enforce_handover_reason"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."gdpr_delete_user_data"("p_contact_id" "uuid", "p_org_id" "uuid" DEFAULT NULL::"uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."gdpr_delete_user_data"("p_contact_id" "uuid", "p_org_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_agent_kpis"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_super_agent_id" "uuid" DEFAULT NULL::"uuid") RETURNS TABLE("agent_user_id" "uuid", "agent_name" "text", "resolved_count" bigint, "avg_resolution_minutes" numeric)
...
ALTER FUNCTION "public"."get_agent_kpis"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_super_agent_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_audit_logs"("p_user_id" "uuid" DEFAULT NULL::"uuid", "p_action" "text" DEFAULT NULL::"text", "p_from" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_to" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_limit" integer DEFAULT 50, "p_offset" integer DEFAULT 0) RETURNS SETOF "public"."audit_logs"
...
ALTER FUNCTION "public"."get_audit_logs"("p_user_id" "uuid", "p_action" "text", "p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_limit" integer, "p_offset" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_channel_chat_counts"("p_from" timestamp with time zone, "p_to" timestamp with time zone) RETURNS TABLE("channel_id" "uuid", "provider" "text", "display_name" "text", "thread_count" bigint)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
...
ALTER FUNCTION "public"."get_channel_chat_counts"("p_from" timestamp with time zone, "p_to" timestamp with time zone) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_chats_timeseries"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_channel" "text" DEFAULT NULL::"text") RETURNS TABLE("bucket" timestamp with time zone, "provider" "text", "count" bigint)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  with scoped as (
...
ALTER FUNCTION "public"."get_chats_timeseries"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_channel" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_containment"("p_from" timestamp with time zone, "p_to" timestamp with time zone) RETURNS TABLE("total_threads" bigint, "ai_resolved_count" bigint, "rate" numeric, "prev_total_threads" bigint, "prev_ai_resolved_count" bigint, "prev_rate" numeric)
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
...
ALTER FUNCTION "public"."get_containment"("p_from" timestamp with time zone, "p_to" timestamp with time zone) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_containment_and_handover"("p_from" timestamp with time zone, "p_to" timestamp with time zone) RETURNS TABLE("total_threads" bigint, "ai_resolved_count" bigint, "containment_rate" numeric, "handover_count" bigint, "handover_rate" numeric)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  with scoped as (
...
ALTER FUNCTION "public"."get_containment_and_handover"("p_from" timestamp with time zone, "p_to" timestamp with time zone) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_database_activity"() RETURNS TABLE("total_inserts" bigint, "total_updates" bigint, "total_deletes" bigint, "total_sequential_scans" bigint, "total_index_scans" bigint, "total_blocks_hit" bigint, "total_blocks_read" bigint, "cache_hit_percentage" numeric)
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  SELECT 
...
ALTER FUNCTION "public"."get_database_activity"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_database_memory_stats"() RETURNS TABLE("shared_buffers_hit" numeric, "shared_buffers_read" numeric, "shared_buffers_hit_ratio" numeric, "cache_hit_ratio" numeric, "heap_hit_ratio" numeric, "idx_scan_ratio" numeric, "total_sequential_scans" bigint, "total_index_scans" bigint)
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  SELECT 
...
ALTER FUNCTION "public"."get_database_memory_stats"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_database_overview"() RETURNS TABLE("total_size_bytes" bigint, "total_size_pretty" "text", "data_size_bytes" bigint, "data_size_pretty" "text", "indexes_size_bytes" bigint, "indexes_size_pretty" "text", "total_tables" bigint, "total_rows" bigint, "total_indexes" bigint, "total_sequences" bigint)
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  SELECT 
...
CREATE OR REPLACE FUNCTION "public"."get_database_stats"() RETURNS TABLE("tablename" "text", "total_size_bytes" bigint, "total_size_pretty" "text", "table_size_bytes" bigint, "table_size_pretty" "text", "indexes_size_bytes" bigint, "indexes_size_pretty" "text", "row_count" bigint, "sequential_scans" bigint, "index_scans" bigint)
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."get_database_stats_detailed"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_database_total_size"() RETURNS TABLE("total_size_bytes" bigint, "total_size_pretty" "text")
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  SELECT 
...
ALTER FUNCTION "public"."get_database_total_size"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_handover_by_agent"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_super_agent_id" "uuid" DEFAULT NULL::"uuid") RETURNS TABLE("agent_user_id" "uuid", "agent_name" "text", "super_agent_id" "uuid", "human_resolved" bigint, "ai_resolved" bigint, "handover_rate" numeric)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  with scoped as (
...
ALTER FUNCTION "public"."get_handover_by_agent"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_super_agent_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_handover_by_super_agent"("p_from" timestamp with time zone, "p_to" timestamp with time zone) RETURNS TABLE("super_agent_id" "uuid", "super_agent_name" "text", "human_resolved" bigint, "ai_resolved" bigint, "handover_rate" numeric)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  with scoped as (
...
ALTER FUNCTION "public"."get_handover_by_super_agent"("p_from" timestamp with time zone, "p_to" timestamp with time zone) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_handover_stats"("p_from" timestamp with time zone, "p_to" timestamp with time zone) RETURNS TABLE("reason" "text", "count" bigint, "total" bigint, "rate" numeric)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  with scoped as (
...
ALTER FUNCTION "public"."get_handover_stats"("p_from" timestamp with time zone, "p_to" timestamp with time zone) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_index_stats"() RETURNS TABLE("tablename" "text", "indexname" "text", "index_size_bytes" bigint, "index_size_pretty" "text", "index_scans" bigint, "index_tup_reads" bigint, "index_tup_fetches" bigint, "idx_blks_hit" bigint, "idx_blks_read" bigint)
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  SELECT 
...
ALTER FUNCTION "public"."get_index_stats"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_non_contained"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_limit" integer DEFAULT 50, "p_offset" integer DEFAULT 0) RETURNS TABLE("id" "uuid", "created_at" timestamp with time zone, "contact_name" "text", "handover_reason" "text", "status" "text")
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select t.id,
...
ALTER FUNCTION "public"."get_non_contained"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_limit" integer, "p_offset" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_response_time_stats"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_channel" "text" DEFAULT NULL::"text") RETURNS TABLE("ai_avg" numeric, "ai_median" numeric, "ai_p90" numeric, "agent_avg" numeric, "agent_median" numeric, "agent_p90" numeric)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  with msgs as (
...
ALTER FUNCTION "public"."get_response_time_stats"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_channel" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_response_times"("p_from" timestamp with time zone, "p_to" timestamp with time zone) RETURNS TABLE("ai_avg_seconds" numeric, "agent_avg_seconds" numeric)
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
...
ALTER FUNCTION "public"."get_response_times"("p_from" timestamp with time zone, "p_to" timestamp with time zone) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."grant_role_bundle"("p_role" "uuid", "p_bundle" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
begin
...
ALTER FUNCTION "public"."grant_role_bundle"("p_role" "uuid", "p_bundle" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."grant_role_permission"("p_role" "uuid", "p_perm" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
begin
...
ALTER FUNCTION "public"."grant_role_permission"("p_role" "uuid", "p_perm" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."has_active_2fa"() RETURNS boolean
    LANGUAGE "sql" STABLE
    SET "search_path" TO ''
    AS $$
  select exists (
...
ALTER FUNCTION "public"."has_active_2fa"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."has_perm"("p_action" "text", "p_resource" "text") RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select exists (
...
ALTER FUNCTION "public"."has_perm"("p_action" "text", "p_resource" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."invite_ttl_seconds"() RETURNS integer
...
ALTER FUNCTION "public"."invite_ttl_seconds"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."is_master_agent"() RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select exists (
...
ALTER FUNCTION "public"."is_master_agent"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."is_master_agent_in_org"("target_org" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE
    AS $$
  select exists (
    select 1
...
ALTER FUNCTION "public"."is_master_agent_in_org"("target_org" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."is_regular_agent_for_channel"("target_org" "uuid", "target_channel" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE
    AS $$
  with ch as (
...
ALTER FUNCTION "public"."is_regular_agent_for_channel"("target_org" "uuid", "target_channel" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."is_super_agent_for_channel"("target_org" "uuid", "target_channel" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE
    AS $$
  select exists (
    select 1
...
ALTER FUNCTION "public"."is_super_agent_for_channel"("target_org" "uuid", "target_channel" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."jakarta_day_start_utc"("p_now" timestamp with time zone) RETURNS timestamp with time zone
...
ALTER FUNCTION "public"."jakarta_day_start_utc"("p_now" timestamp with time zone) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."jakarta_month_start_utc"("p_now" timestamp with time zone) RETURNS timestamp with time zone
    LANGUAGE "plpgsql" IMMUTABLE
    AS $$
DECLARE v timestamptz;
BEGIN
...
ALTER FUNCTION "public"."jakarta_month_start_utc"("p_now" timestamp with time zone) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."log_action"("p_action" "text", "p_resource" "text", "p_resource_id" "text" DEFAULT NULL::"text", "p_context" "jsonb" DEFAULT '{}'::"jsonb", "p_ip" "text" DEFAULT NULL::"text", "p_user_agent" "text" DEFAULT NULL::"text", "p_org_id" "uuid" DEFAULT NULL::"uuid", "p_user_id" "uuid" DEFAULT NULL::"uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."log_action"("p_action" "text", "p_resource" "text", "p_resource_id" "text", "p_context" "jsonb", "p_ip" "text", "p_user_agent" "text", "p_org_id" "uuid", "p_user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."log_sync_deletion"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
begin
...
ALTER FUNCTION "public"."log_sync_deletion"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."path_channel_id"("name" "text") RETURNS "uuid"
    LANGUAGE "sql" IMMUTABLE
    AS $$
...
ALTER FUNCTION "public"."path_channel_id"("name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."path_org_id"("name" "text") RETURNS "uuid"
    LANGUAGE "sql" IMMUTABLE
    AS $$
...
ALTER FUNCTION "public"."path_org_id"("name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."refresh_daily_monthly_tokens"() RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
...
ALTER FUNCTION "public"."refresh_daily_monthly_tokens"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."refresh_used_tokens_for_super_agents"("p_from" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_to" timestamp with time zone DEFAULT NULL::timestamp with time zone) RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
begin
  with cluster as (
...
ALTER FUNCTION "public"."refresh_used_tokens_for_super_agents"("p_from" timestamp with time zone, "p_to" timestamp with time zone) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."revoke_role_bundle"("p_role" "uuid", "p_bundle" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
begin
...
ALTER FUNCTION "public"."revoke_role_bundle"("p_role" "uuid", "p_bundle" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."revoke_role_permission"("p_role" "uuid", "p_perm" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
begin
...
ALTER FUNCTION "public"."revoke_role_permission"("p_role" "uuid", "p_perm" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."schedule_auto_resolve_for_open_threads"() RETURNS integer
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  with last_msg as (
...
ALTER FUNCTION "public"."schedule_auto_resolve_for_open_threads"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."set_ai_handoff_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."set_ai_handoff_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."set_ai_resolution_if_closed"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
begin
...
ALTER FUNCTION "public"."set_ai_resolution_if_closed"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."set_auto_resolve_timestamp"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."set_auto_resolve_timestamp"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."set_thread_auto_resolve_after_message"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."set_thread_auto_resolve_after_message"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."takeover_thread"("p_thread_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  UPDATE public.threads t
...
ALTER FUNCTION "public"."takeover_thread"("p_thread_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."validate_handover_reason"("new_handover" boolean, "reason" "text") RETURNS boolean
    LANGUAGE "sql"
    AS $$
...
ALTER FUNCTION "public"."validate_handover_reason"("new_handover" boolean, "reason" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."verify_email_2fa"("p_user" "uuid", "p_code" "text", "p_session_minutes" integer DEFAULT 15) RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'extensions'
    AS $$
declare
...
ALTER FUNCTION "public"."verify_email_2fa"("p_user" "uuid", "p_code" "text", "p_session_minutes" integer) OWNER TO "postgres";
...
ALTER TABLE "public"."ai_profiles" OWNER TO "postgres";
...
ALTER TABLE "public"."bundle_permissions" OWNER TO "postgres";
...
ALTER TABLE "public"."channel_agents" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."circuit_breaker_metrics" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
ALTER TABLE "public"."circuit_breaker_metrics" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "public"."circuit_breaker_metrics_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "public"."circuit_breaker_metrics_id_seq" OWNER TO "postgres";
...
ALTER TABLE "public"."csat_responses" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."n8n_webhook_routes" (
...
ALTER TABLE "public"."n8n_webhook_routes" OWNER TO "postgres";
...
ALTER TABLE "public"."openai_usage_snapshots" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "public"."openai_usage_snapshots_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "public"."openai_usage_snapshots_id_seq" OWNER TO "postgres";
...
ALTER TABLE "public"."permission_bundles" OWNER TO "postgres";
...
ALTER TABLE "public"."rbac_policies" OWNER TO "postgres";
...
ALTER TABLE "public"."role_bundles" OWNER TO "postgres";
...
ALTER TABLE "public"."super_agent_members" OWNER TO "postgres";
...
CREATE SEQUENCE IF NOT EXISTS "public"."sync_deletions_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "public"."sync_deletions_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "public"."sync_deletions_id_seq" OWNED BY "public"."sync_deletions"."id";
...
ALTER TABLE "public"."token_topups" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."twofa_challenges" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."twofa_challenges" OWNER TO "postgres";
...
ALTER TABLE "public"."twofa_sessions" OWNER TO "postgres";
...
ALTER VIEW "public"."v_current_user_permissions" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."v_human_agents" AS
 WITH "base" AS (
...
ALTER VIEW "public"."v_human_agents" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."v_super_agent_token_usage" AS
...
ALTER VIEW "public"."v_super_agent_token_usage" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."sync_deletions" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."sync_deletions_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."sync_deletions"
    ADD CONSTRAINT "sync_deletions_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "sync_deletions_processed_at_idx" ON "public"."sync_deletions" USING "brin" ("processed_at");
...
CREATE OR REPLACE TRIGGER "set_ai_handoff_at_on_assignee_change" BEFORE UPDATE ON "public"."threads" FOR EACH ROW WHEN (("old"."assignee_user_id" IS DISTINCT FROM "new"."assignee_user_id")) EXECUTE FUNCTION "public"."set_ai_handoff_at"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."ai_models" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."ai_profiles" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."ai_sessions" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."alert_rules" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."alerts" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."audit_logs" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."bundle_permissions" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."channel_agents" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."channels" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."contact_identities" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."contact_labels" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."contacts" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."csat_responses" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."documents" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."files" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."labels" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."messages" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."n8n_chat_histories" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."n8n_webhook_routes" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."openai_usage_snapshots" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."org_members" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."orgs" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."permission_bundles" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."permissions" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."role_bundles" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."role_permissions" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."roles" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."super_agent_members" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();
...
CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."token_balances" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."token_topups" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."token_usage_logs" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."user_invites" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();



CREATE OR REPLACE TRIGGER "sync_deletion_log" AFTER DELETE ON "public"."user_roles" FOR EACH ROW EXECUTE FUNCTION "public"."log_sync_deletion"();
...
CREATE OR REPLACE TRIGGER "tr_enforce_handover_reason" BEFORE INSERT OR UPDATE ON "public"."threads" FOR EACH ROW EXECUTE FUNCTION "public"."enforce_handover_reason"();



CREATE OR REPLACE TRIGGER "tr_refresh_daily_monthly_after_log" AFTER INSERT OR DELETE OR UPDATE ON "public"."token_usage_logs" FOR EACH STATEMENT EXECUTE FUNCTION "public"."after_token_log_refresh_daily_monthly"();



CREATE OR REPLACE TRIGGER "tr_refresh_used_tokens_after_log" AFTER INSERT OR DELETE OR UPDATE ON "public"."token_usage_logs" FOR EACH STATEMENT EXECUTE FUNCTION "public"."after_token_log_refresh_used_tokens"();



CREATE OR REPLACE TRIGGER "tr_reopen_thread_on_user_message" AFTER INSERT ON "public"."messages" FOR EACH ROW EXECUTE FUNCTION "public"."reopen_thread_on_user_message"();



CREATE OR REPLACE TRIGGER "tr_set_ai_resolution_if_closed" BEFORE UPDATE ON "public"."threads" FOR EACH ROW EXECUTE FUNCTION "public"."set_ai_resolution_if_closed"();



CREATE OR REPLACE TRIGGER "tr_set_thread_auto_resolve_after_message" AFTER INSERT ON "public"."messages" FOR EACH ROW EXECUTE FUNCTION "public"."set_thread_auto_resolve_after_message"();

ALTER TABLE "public"."messages" DISABLE TRIGGER "tr_set_thread_auto_resolve_after_message";



CREATE OR REPLACE TRIGGER "trigger_cancel_auto_resolve_on_user_message" AFTER INSERT ON "public"."messages" FOR EACH ROW EXECUTE FUNCTION "public"."cancel_auto_resolve_on_user_message"();



CREATE OR REPLACE TRIGGER "trigger_set_auto_resolve_timestamp" AFTER INSERT ON "public"."messages" FOR EACH ROW EXECUTE FUNCTION "public"."set_auto_resolve_timestamp"();
...
ALTER TABLE ONLY "public"."org_settings"
    ADD CONSTRAINT "org_settings_ai_paused_by_user_id_fkey" FOREIGN KEY ("ai_paused_by_user_id") REFERENCES "public"."users_profile"("user_id");
...
CREATE POLICY "Enable read access for all users" ON "public"."ai_models" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "auth read" ON "public"."ai_profiles" FOR SELECT TO "authenticated" USING (((( SELECT "auth"."uid"() AS "uid") IS NOT NULL) AND "public"."has_perm"('read'::"text", 'ai_profiles'::"text")));
...
GRANT ALL ON FUNCTION "public"."after_token_log_refresh_daily_monthly"() TO "anon";
GRANT ALL ON FUNCTION "public"."after_token_log_refresh_daily_monthly"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."after_token_log_refresh_daily_monthly"() TO "service_role";



GRANT ALL ON FUNCTION "public"."after_token_log_refresh_used_tokens"() TO "anon";
GRANT ALL ON FUNCTION "public"."after_token_log_refresh_used_tokens"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."after_token_log_refresh_used_tokens"() TO "service_role";



GRANT ALL ON FUNCTION "public"."auto_close_due_threads"() TO "anon";
GRANT ALL ON FUNCTION "public"."auto_close_due_threads"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."auto_close_due_threads"() TO "service_role";



GRANT ALL ON FUNCTION "public"."auto_resolve_threads"() TO "anon";
GRANT ALL ON FUNCTION "public"."auto_resolve_threads"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."auto_resolve_threads"() TO "service_role";



GRANT ALL ON FUNCTION "public"."can_read_thread"("p_thread_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."can_read_thread"("p_thread_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."can_read_thread"("p_thread_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."cancel_auto_resolve_on_user_message"() TO "anon";
GRANT ALL ON FUNCTION "public"."cancel_auto_resolve_on_user_message"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."cancel_auto_resolve_on_user_message"() TO "service_role";



GRANT ALL ON FUNCTION "public"."check_and_auto_resolve_threads"() TO "anon";
GRANT ALL ON FUNCTION "public"."check_and_auto_resolve_threads"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."check_and_auto_resolve_threads"() TO "service_role";



GRANT ALL ON FUNCTION "public"."cleanup_old_chat_data"("p_org_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."cleanup_old_chat_data"("p_org_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."cleanup_old_chat_data"("p_org_id" "uuid") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."create_email_2fa_challenge"("p_user" "uuid", "p_ttl_seconds" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."create_email_2fa_challenge"("p_user" "uuid", "p_ttl_seconds" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."enforce_handover_reason"() TO "anon";
GRANT ALL ON FUNCTION "public"."enforce_handover_reason"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."enforce_handover_reason"() TO "service_role";



GRANT ALL ON FUNCTION "public"."gdpr_delete_user_data"("p_contact_id" "uuid", "p_org_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."gdpr_delete_user_data"("p_contact_id" "uuid", "p_org_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."gdpr_delete_user_data"("p_contact_id" "uuid", "p_org_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_agent_kpis"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_super_agent_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_agent_kpis"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_super_agent_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_agent_kpis"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_super_agent_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_audit_logs"("p_user_id" "uuid", "p_action" "text", "p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_limit" integer, "p_offset" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_audit_logs"("p_user_id" "uuid", "p_action" "text", "p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_limit" integer, "p_offset" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_audit_logs"("p_user_id" "uuid", "p_action" "text", "p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_limit" integer, "p_offset" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_channel_chat_counts"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "anon";
GRANT ALL ON FUNCTION "public"."get_channel_chat_counts"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_channel_chat_counts"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_chats_timeseries"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_channel" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_chats_timeseries"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_channel" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_chats_timeseries"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_channel" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_containment"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "anon";
GRANT ALL ON FUNCTION "public"."get_containment"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_containment"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_containment_and_handover"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "anon";
GRANT ALL ON FUNCTION "public"."get_containment_and_handover"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_containment_and_handover"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_database_activity"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_database_activity"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_database_activity"() TO "service_role";



GRANT ALL ON FUNCTION "public"."get_database_memory_stats"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_database_memory_stats"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_database_memory_stats"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_database_stats_detailed"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_database_stats_detailed"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_database_stats_detailed"() TO "service_role";



GRANT ALL ON FUNCTION "public"."get_database_total_size"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_database_total_size"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_database_total_size"() TO "service_role";



GRANT ALL ON FUNCTION "public"."get_handover_by_agent"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_super_agent_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_handover_by_agent"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_super_agent_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_handover_by_agent"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_super_agent_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_handover_by_super_agent"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "anon";
GRANT ALL ON FUNCTION "public"."get_handover_by_super_agent"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_handover_by_super_agent"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_handover_stats"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "anon";
GRANT ALL ON FUNCTION "public"."get_handover_stats"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_handover_stats"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_index_stats"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_index_stats"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_index_stats"() TO "service_role";



GRANT ALL ON FUNCTION "public"."get_non_contained"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_limit" integer, "p_offset" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_non_contained"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_limit" integer, "p_offset" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_non_contained"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_limit" integer, "p_offset" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_response_time_stats"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_channel" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_response_time_stats"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_channel" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_response_time_stats"("p_from" timestamp with time zone, "p_to" timestamp with time zone, "p_channel" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_response_times"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "anon";
GRANT ALL ON FUNCTION "public"."get_response_times"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_response_times"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "service_role";



GRANT ALL ON FUNCTION "public"."grant_role_bundle"("p_role" "uuid", "p_bundle" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."grant_role_bundle"("p_role" "uuid", "p_bundle" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."grant_role_bundle"("p_role" "uuid", "p_bundle" "uuid") TO "service_role";



REVOKE ALL ON FUNCTION "public"."grant_role_permission"("p_role" "uuid", "p_perm" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."grant_role_permission"("p_role" "uuid", "p_perm" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."grant_role_permission"("p_role" "uuid", "p_perm" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."grant_role_permission"("p_role" "uuid", "p_perm" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."handle_user_delete"() TO "supabase_auth_admin";



REVOKE ALL ON FUNCTION "public"."has_active_2fa"() FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."has_active_2fa"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."has_active_2fa"() TO "service_role";



GRANT ALL ON FUNCTION "public"."has_perm"("p_action" "text", "p_resource" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."has_perm"("p_action" "text", "p_resource" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."has_perm"("p_action" "text", "p_resource" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."invite_ttl_seconds"() TO "anon";
GRANT ALL ON FUNCTION "public"."invite_ttl_seconds"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."invite_ttl_seconds"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."is_master_agent"() TO "anon";
GRANT ALL ON FUNCTION "public"."is_master_agent"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_master_agent"() TO "service_role";



GRANT ALL ON FUNCTION "public"."is_master_agent_in_org"("target_org" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."is_master_agent_in_org"("target_org" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_master_agent_in_org"("target_org" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."is_regular_agent_for_channel"("target_org" "uuid", "target_channel" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."is_regular_agent_for_channel"("target_org" "uuid", "target_channel" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_regular_agent_for_channel"("target_org" "uuid", "target_channel" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."is_super_agent_for_channel"("target_org" "uuid", "target_channel" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."is_super_agent_for_channel"("target_org" "uuid", "target_channel" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_super_agent_for_channel"("target_org" "uuid", "target_channel" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."jakarta_day_start_utc"("p_now" timestamp with time zone) TO "anon";
GRANT ALL ON FUNCTION "public"."jakarta_day_start_utc"("p_now" timestamp with time zone) TO "authenticated";
GRANT ALL ON FUNCTION "public"."jakarta_day_start_utc"("p_now" timestamp with time zone) TO "service_role";



GRANT ALL ON FUNCTION "public"."jakarta_month_start_utc"("p_now" timestamp with time zone) TO "anon";
GRANT ALL ON FUNCTION "public"."jakarta_month_start_utc"("p_now" timestamp with time zone) TO "authenticated";
GRANT ALL ON FUNCTION "public"."jakarta_month_start_utc"("p_now" timestamp with time zone) TO "service_role";



GRANT ALL ON FUNCTION "public"."log_action"("p_action" "text", "p_resource" "text", "p_resource_id" "text", "p_context" "jsonb", "p_ip" "text", "p_user_agent" "text", "p_org_id" "uuid", "p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."log_action"("p_action" "text", "p_resource" "text", "p_resource_id" "text", "p_context" "jsonb", "p_ip" "text", "p_user_agent" "text", "p_org_id" "uuid", "p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."log_action"("p_action" "text", "p_resource" "text", "p_resource_id" "text", "p_context" "jsonb", "p_ip" "text", "p_user_agent" "text", "p_org_id" "uuid", "p_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."log_sync_deletion"() TO "anon";
GRANT ALL ON FUNCTION "public"."log_sync_deletion"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."log_sync_deletion"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."path_channel_id"("name" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."path_channel_id"("name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."path_channel_id"("name" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."path_org_id"("name" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."path_org_id"("name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."path_org_id"("name" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."refresh_daily_monthly_tokens"() TO "anon";
GRANT ALL ON FUNCTION "public"."refresh_daily_monthly_tokens"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."refresh_daily_monthly_tokens"() TO "service_role";



GRANT ALL ON FUNCTION "public"."refresh_used_tokens_for_super_agents"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "anon";
GRANT ALL ON FUNCTION "public"."refresh_used_tokens_for_super_agents"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "authenticated";
GRANT ALL ON FUNCTION "public"."refresh_used_tokens_for_super_agents"("p_from" timestamp with time zone, "p_to" timestamp with time zone) TO "service_role";



GRANT ALL ON FUNCTION "public"."reopen_thread_on_user_message"() TO "anon";
GRANT ALL ON FUNCTION "public"."reopen_thread_on_user_message"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."reopen_thread_on_user_message"() TO "service_role";



GRANT ALL ON FUNCTION "public"."revoke_role_bundle"("p_role" "uuid", "p_bundle" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."revoke_role_bundle"("p_role" "uuid", "p_bundle" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."revoke_role_bundle"("p_role" "uuid", "p_bundle" "uuid") TO "service_role";



REVOKE ALL ON FUNCTION "public"."revoke_role_permission"("p_role" "uuid", "p_perm" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."revoke_role_permission"("p_role" "uuid", "p_perm" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."revoke_role_permission"("p_role" "uuid", "p_perm" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."revoke_role_permission"("p_role" "uuid", "p_perm" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."schedule_auto_resolve_for_open_threads"() TO "anon";
GRANT ALL ON FUNCTION "public"."schedule_auto_resolve_for_open_threads"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."schedule_auto_resolve_for_open_threads"() TO "service_role";



GRANT ALL ON FUNCTION "public"."set_ai_handoff_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_ai_handoff_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_ai_handoff_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."set_ai_resolution_if_closed"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_ai_resolution_if_closed"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_ai_resolution_if_closed"() TO "service_role";



GRANT ALL ON FUNCTION "public"."set_auto_resolve_timestamp"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_auto_resolve_timestamp"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_auto_resolve_timestamp"() TO "service_role";



GRANT ALL ON FUNCTION "public"."set_thread_auto_resolve_after_message"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_thread_auto_resolve_after_message"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_thread_auto_resolve_after_message"() TO "service_role";



GRANT ALL ON FUNCTION "public"."takeover_thread"("p_thread_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."takeover_thread"("p_thread_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."takeover_thread"("p_thread_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."validate_handover_reason"("new_handover" boolean, "reason" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."validate_handover_reason"("new_handover" boolean, "reason" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."validate_handover_reason"("new_handover" boolean, "reason" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."verify_email_2fa"("p_user" "uuid", "p_code" "text", "p_session_minutes" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."verify_email_2fa"("p_user" "uuid", "p_code" "text", "p_session_minutes" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."verify_email_2fa"("p_user" "uuid", "p_code" "text", "p_session_minutes" integer) TO "service_role";
...
GRANT ALL ON TABLE "public"."ai_profiles" TO "authenticated";
GRANT ALL ON TABLE "public"."ai_profiles" TO "service_role";
...
GRANT ALL ON TABLE "public"."bundle_permissions" TO "anon";
GRANT ALL ON TABLE "public"."bundle_permissions" TO "authenticated";
GRANT ALL ON TABLE "public"."bundle_permissions" TO "service_role";



GRANT ALL ON TABLE "public"."channel_agents" TO "authenticated";
GRANT ALL ON TABLE "public"."channel_agents" TO "service_role";
...
GRANT ALL ON TABLE "public"."circuit_breaker_metrics" TO "anon";
GRANT ALL ON TABLE "public"."circuit_breaker_metrics" TO "authenticated";
GRANT ALL ON TABLE "public"."circuit_breaker_metrics" TO "service_role";



GRANT ALL ON SEQUENCE "public"."circuit_breaker_metrics_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."circuit_breaker_metrics_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."circuit_breaker_metrics_id_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."csat_responses" TO "authenticated";
GRANT ALL ON TABLE "public"."csat_responses" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."messages_seq_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."messages_seq_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."n8n_webhook_routes" TO "anon";
GRANT ALL ON TABLE "public"."n8n_webhook_routes" TO "authenticated";
GRANT ALL ON TABLE "public"."n8n_webhook_routes" TO "service_role";



GRANT ALL ON TABLE "public"."openai_usage_snapshots" TO "anon";
GRANT ALL ON TABLE "public"."openai_usage_snapshots" TO "authenticated";
GRANT ALL ON TABLE "public"."openai_usage_snapshots" TO "service_role";



GRANT ALL ON SEQUENCE "public"."openai_usage_snapshots_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."openai_usage_snapshots_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."openai_usage_snapshots_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."org_members" TO "authenticated";
GRANT ALL ON TABLE "public"."org_members" TO "service_role";
GRANT DELETE ON TABLE "public"."org_members" TO "supabase_auth_admin";
...
GRANT ALL ON TABLE "public"."permission_bundles" TO "anon";
GRANT ALL ON TABLE "public"."permission_bundles" TO "authenticated";
GRANT ALL ON TABLE "public"."permission_bundles" TO "service_role";
...
GRANT ALL ON TABLE "public"."rbac_policies" TO "anon";
GRANT ALL ON TABLE "public"."rbac_policies" TO "authenticated";
GRANT ALL ON TABLE "public"."rbac_policies" TO "service_role";



GRANT ALL ON TABLE "public"."role_bundles" TO "anon";
GRANT ALL ON TABLE "public"."role_bundles" TO "authenticated";
GRANT ALL ON TABLE "public"."role_bundles" TO "service_role";
...
GRANT ALL ON TABLE "public"."super_agent_members" TO "anon";
GRANT ALL ON TABLE "public"."super_agent_members" TO "authenticated";
GRANT ALL ON TABLE "public"."super_agent_members" TO "service_role";



GRANT ALL ON TABLE "public"."sync_deletions" TO "anon";
GRANT ALL ON TABLE "public"."sync_deletions" TO "authenticated";
GRANT ALL ON TABLE "public"."sync_deletions" TO "service_role";



GRANT ALL ON SEQUENCE "public"."sync_deletions_id_seq" TO "anon";
...
GRANT SELECT,INSERT ON TABLE "public"."threads" TO "anon";
...
GRANT ALL ON TABLE "public"."token_topups" TO "authenticated";
GRANT ALL ON TABLE "public"."token_topups" TO "service_role";
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,UPDATE ON TABLE "public"."user_roles" TO "supabase_auth_admin";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,UPDATE ON TABLE "public"."user_roles" TO "supabase_admin";



GRANT ALL ON TABLE "public"."users_profile" TO "authenticated";
GRANT ALL ON TABLE "public"."users_profile" TO "service_role";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,UPDATE ON TABLE "public"."users_profile" TO "supabase_auth_admin";
GRANT ALL ON TABLE "public"."users_profile" TO "anon";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,UPDATE ON TABLE "public"."users_profile" TO "supabase_admin";



GRANT ALL ON TABLE "public"."v_current_user_permissions" TO "anon";
GRANT ALL ON TABLE "public"."v_current_user_permissions" TO "authenticated";
GRANT ALL ON TABLE "public"."v_current_user_permissions" TO "service_role";



GRANT ALL ON TABLE "public"."v_human_agents" TO "anon";
GRANT ALL ON TABLE "public"."v_human_agents" TO "authenticated";
GRANT ALL ON TABLE "public"."v_human_agents" TO "service_role";



GRANT ALL ON TABLE "public"."v_super_agent_token_usage" TO "anon";
GRANT ALL ON TABLE "public"."v_super_agent_token_usage" TO "authenticated";
GRANT ALL ON TABLE "public"."v_super_agent_token_usage" TO "service_role";
